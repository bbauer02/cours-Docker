...
== Exercices : Création d’images

=== Exercice 1 : Création d’une image à partir d’un container
...
=== Exercice 2 : Dockerizez un serveur web simple
...
[NOTE]
====
Dans ce Dockerfile, l'image officielle golang est utilisée comme
...
=== Exercice : Prise en compte du cache
...
== Les commandes de base avec docker image.
...
== Exercice : Analyse du contenu d'une image
