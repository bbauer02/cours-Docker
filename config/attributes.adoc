...
:_git_remote_for_current_adocument: https://github.com/bbauer02/cours-Docker
...
:_git_remotes_for_students: https://github.com/bbauer02/3wa_docker.git
...
:_url_to_repo_for_students: https://github.com/bbauer02/3wa_docker.git
...
:_cover_image: ../images/bg_docker.jpeg
